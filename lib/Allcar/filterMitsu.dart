...
Future<List<Cars>> getFilterMitsu() async {
    ...
    if (result.statusCode != 200) {
      ...
      //remark99
      return list1
          .where((p) => p.name.toLowerCase().contains('mitsubishi'.toLowerCase()))
          .toList();
    } //e else
    //remark99
  } //ef
...
class FilterMitsu extends StatelessWidget {
  @override
