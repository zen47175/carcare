...
Future<List<Cars>> getFilterHyundai() async {
  ...
  if (result.statusCode != 200) {
    ...
    //remark99
    return list1
        .where((p) => p.name.toLowerCase().contains('hyundai'.toLowerCase()))
        .toList();
  } //e else
  //remark99
} //ef

class FilterHyundai extends StatelessWidget {
  @override
