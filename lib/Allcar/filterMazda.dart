...
Future<List<Cars>> getFilterMazda() async {
    ...
    if (result.statusCode != 200) {
      ...
      //remark99
      return list1
          .where((p) => p.name.toLowerCase().contains('mazda'.toLowerCase()))
          .toList();
    } //e else
    //remark99
  } //ef
...
class FilterMazda extends StatelessWidget {
  @override
