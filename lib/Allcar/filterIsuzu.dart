...
Future<List<Cars>> getFilterIsuzu() async {
    ...
    if (result.statusCode != 200) {
      ...
      //remark99
      return list1
          .where((p) => p.name.toLowerCase().contains('isuzu'.toLowerCase()))
          .toList();
    } //e else
    //remark99
  } //ef
...
class FilterIsuzu extends StatelessWidget {
  @override
