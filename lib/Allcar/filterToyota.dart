...
Future<List<Cars>> getFilterToyota() async {
    ...
    if (result.statusCode != 200) {
      ...
      //remark99
      return list1
          .where((p) => p.name.toLowerCase().contains('toyota'.toLowerCase()))
          .toList();
    } //e else
    //remark99
  } //ef
...
class FilterToyota extends StatelessWidget {
  @override
